...
class customerEditForm extends StatefulWidget {
  ...
  customerEditForm({var value}):_value = value;
...
class _elementFormState extends State<customerEditForm> {
  var uid;
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text("Пожалуйста, введите действительный адрес emailap"),
              actions: [
                TextButton(
                  child: Text("OK"),
                  onPressed: () {
